/* Mostrar los mese del año, pidiendole al ususario un numero ente (1-12)
...
int main(){
	...
	std::cout<<"Ingrese un numero para mostrarle el mes. \n<<";
	std::cin>>mes;
	...
	switch(mes){
		...
		default:std::cout<<"No hay un mes fuera de ese rango."<<std::endl;
	}
